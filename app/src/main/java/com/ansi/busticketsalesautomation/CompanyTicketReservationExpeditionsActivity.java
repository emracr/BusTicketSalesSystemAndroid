...
public class CompanyTicketReservationExpeditionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_ticket_reservation_expeditions);

        databaseHelper = new DatabaseHelper(this);

        expeditionsLayout = findViewById(R.id.ticketReservationExpeditionsLayoutActivityCompanyReservation);
        lblCityFromCityTo = findViewById(R.id.lblCityFromCityToActivityCompanyTicketReservationExpeditions);
        lblTravelDate = findViewById(R.id.lblTravelDateActivityCompanyTicketReservationExpeditions);
        ...
        List<ExpeditionDto> expeditions = databaseHelper.getExpeditionsByCompanyIdAndCityFromAndCityToForTicketReservation(CompanyCredentials.COMPANY.getId(), ReservationInformation.CITY_FROM, ReservationInformation.CITY_TO);
            ...
            for (ExpeditionDto expedition : expeditions) {
                ...
                btnRedirectToSeat.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), CompanyTicketReservationSeatSelectionActivity.class);
