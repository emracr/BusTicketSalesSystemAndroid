...
public class AdminReservationSeatSelectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_reservation_seat_selection);
        ...
        btnSeat1 = findViewById(R.id.adminBtnSeat1);
        btnSeat2 = findViewById(R.id.adminBtnSeat2);
        btnSeat3 = findViewById(R.id.adminBtnSeat3);
        btnSeat4 = findViewById(R.id.adminBtnSeat4);
        btnSeat5 = findViewById(R.id.adminBtnSeat5);
        btnSeat6 = findViewById(R.id.adminBtnSeat6);
        btnSeat7 = findViewById(R.id.adminBtnSeat7);
        btnSeat8 = findViewById(R.id.adminBtnSeat8);
        btnSeat9 =  findViewById(R.id.adminBtnSeat9);
        btnSeat10 = findViewById(R.id.adminBtnSeat10);
        btnSeat11 = findViewById(R.id.adminBtnSeat11);
        btnSeat12 = findViewById(R.id.adminBtnSeat12);
        btnSeat13 = findViewById(R.id.adminBtnSeat13);
        btnSeat14 = findViewById(R.id.adminBtnSeat14);
        btnSeat15 = findViewById(R.id.adminBtnSeat15);
        btnSeat16 = findViewById(R.id.adminBtnSeat16);
        btnSeat17 = findViewById(R.id.adminBtnSeat17);
        btnSeat18 = findViewById(R.id.adminBtnSeat18);
        btnSeat19 = findViewById(R.id.adminBtnSeat19);
        btnSeat20 = findViewById(R.id.adminBtnSeat20);
        btnSeat21 = findViewById(R.id.adminBtnSeat21);
        btnSeat22 = findViewById(R.id.adminBtnSeat22);
        btnSeat23 = findViewById(R.id.adminBtnSeat23);
        btnSeat24 = findViewById(R.id.adminBtnSeat24);
        btnConfirmSeat = findViewById(R.id.btnConfirmSeatAdmin);
        ...
        btnConfirmSeat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedSeatNumber > 0){
                    ...
                    Intent intent = new Intent(getApplicationContext(), AdminTicketSummaryActivity.class);
