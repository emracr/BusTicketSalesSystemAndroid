...
public class CompanyTicketReservationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_ticket_reservation);

        databaseHelper = new DatabaseHelper(this);

        tbTravelDate = findViewById(R.id.tbTravelDateTicketReservationActivity);
        spnTravelFrom = findViewById(R.id.spnTravelFromTicketReservationActivity);
        spnTravelTo = findViewById(R.id.spnTravelToTicketReservationActivity);
        pbSwap = findViewById(R.id.pbSwapTicketReservationActivity);
        btnGetTravels = findViewById(R.id.btnGetExpeditionsTicketReservationActivity);
        ...
        tbTravelDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(CompanyTicketReservationActivity.this, date, myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH));
        ...
        btnGetTravels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedCityFromId <= 0){
                    ...
                    Intent intent = new Intent(getApplicationContext(), CompanyTicketReservationExpeditionsActivity.class);
